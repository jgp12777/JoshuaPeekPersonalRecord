class CouchArmrestLeft {
    constructor(width = 3.4, depth = 1.7, height = 2.6, slantHeight = 0.3, alias = 'couch-armrest-left') {
        this.alias = alias;
        this.width = width;
        this.depth = depth;
        this.height = height;
    ...
    build() {
        ...
        // Left armrest vertices with high edge on outside (-z) and low edge inward (+z)
        this.vertices = [
            // Bottom face
            -w, 0, -d,
            w, 0, -d,
